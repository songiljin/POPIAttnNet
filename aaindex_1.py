...
def peptide_into_property(peptides,filter_property_index=None,max_min=0):
    ...
    for peptide in peptides:
        transfer_peptide= aaindex.amino_transfer_property(peptide.upper(),amino_property)
...
total_property= aaindex.get_primary_amino_data()
amino_property= aaindex.amino_property_filter_NA_processing(total_property)
peptides = ["ARNDCQEGHILKMFPSTWYV"]
peptides_number = peptide_into_property(peptides)