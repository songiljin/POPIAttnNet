...
class Dataset():
    ...
    def get_dataset(self,peptides,labels,positive_length):
        ...
        datasets= peptide_into_property(peptides,0,max_min=2)  #property_length=553
...
#dataset,label,positive_length=get_dataset(all_peptide_seqs,label,positive_length)
    ...
    def train_val_test_dataset(self):
        ...
        val_data =  peptide_into_property(self.val_peptides,0,max_min=2)
        val_data = val_data.astype('float32')
        val_label = self.val_labels
        test_data = peptide_into_property(self.test_peptides,0,max_min=2)
